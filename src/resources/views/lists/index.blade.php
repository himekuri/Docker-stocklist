...
@section('content')
    ...
    <div class="bl_main">
        ...
        <div class = "bl_filter hp_mb">
            <button type="button" class="bl_filter_item el_btn" onclick="location.href='/lists/filter'">　買い出しのみ　</button>
            <button type="button" class="bl_filter_item el_btn" disabled>残りわずかも含む</button>
        </div>
                        ...
                        <tbody>
                            @foreach($shop->items->whereIn('status',[1,2]) as $item)
                                <tr>
                                    ...
                                    @else
                                        <div class="hp_colorOrange">残りわずか</div>
                                    </td>
                                    @endif
